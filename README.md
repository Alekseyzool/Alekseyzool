...
| [E-commerce OLIST](https://github.com/Alekseyzool/E-commerce_OLIST) | Цель — удержать покупателей маркетплейса; выгрузил данные, провел когортный анализ, приоритизировал гипотезы и посчитал ключевые A/B-метрики для продуктовых решений. | `Python`, `Pandas`, `NumPy`, `Matplotlib`, `Seaborn`, `SQLAlchemy` |
